...
public class MainSmoothCamera extends BaseGameActivity {
...
//    public static final int CAMERA_HEIGHT = 1080;
    ...
    public EngineOptions onCreateEngineOptions() {
        ...
        mCameraOne = new SmoothCamera(0, 0, CAMERA_WIDTH, CAMERA_HEIGHT, 0, 0, 0.4f) {
        ...
        mCameraTwo = new SmoothCamera(0, 0, CAMERA_WIDTH, CAMERA_HEIGHT, 0, 0, 1.2f) {
    ...
    public void onPopulateScene(Scene pScene, OnPopulateSceneCallback pOnPopulateSceneCallback) {
        ...
        Rectangle rectangleOne = new Rectangle(CAMERA_WIDTH * 0.5f, CAMERA_HEIGHT * 0.5f, rectangleDimensions, rectangleDimensions, mEngine.getVertexBufferObjectManager());
        rectangleOne.setColor(Color.BLUE);
        mSceneOne.attachChild(rectangleOne);

		/* Apply a rectangle to the center of the second scene */
        Rectangle rectangleTwo = new Rectangle(CAMERA_WIDTH * 0.5f, CAMERA_HEIGHT * 0.5f, rectangleDimensions, rectangleDimensions, mEngine.getVertexBufferObjectManager());
