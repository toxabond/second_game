...
public class MainMenu extends ManagedMenuScene {
    ...
    public void onLoadScene() {
        ...
        BackgroundSprite = new Sprite(ResourceManager.getInstance().cameraWidth * .5f, 0, ResourceManager.menuBackgroundTextureRegion, ResourceManager.getInstance().engine.getVertexBufferObjectManager());
        ...
        for (Sprite curCloudSprite : CloudSprites) {
            curCloudSprite = new Sprite(
                ...
                protected void onManagedUpdate(final float pSecondsElapsed) {
                    ...
                    if (this.getX() < -(this.getWidth() * this.getScaleX())) {
        ...
        PlayButtonText.setPosition((PlayButton.getWidth()-PlayButtonText.getWidth()) / 2, (PlayButton.getHeight()-PlayButtonText.getHeight()) / 2);
        ...
        OptionsButtonText.setPosition((OptionsButton.getWidth()-OptionsButtonText.getWidth()) / 2, (OptionsButton.getHeight()-OptionsButtonText.getHeight()) / 2);
        ...
        TitleText.setPosition((ResourceManager.getInstance().cameraWidth - TitleText.getWidth()) / 2, (ResourceManager.getInstance().cameraHeight * 2) / 3f);
