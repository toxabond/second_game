...
//		EngineOptions engineOptions = new EngineOptions(true, ScreenOrientation.LANDSCAPE_SENSOR, new FillResolutionPolicy(), new Camera(0, 0, cameraWidth, cameraHeight));
		Camera pCamera = new Camera(0, 0, DESIGN_SCREEN_WIDTH_PIXELS, DESIGN_SCREEN_WIDTH_PIXELS);
		//pCamera.offsetCenter(DESIGN_SCREEN_WIDTH_PIXELS*3, DESIGN_SCREEN_WIDTH_PIXELS*2);
		EngineOptions engineOptions = new EngineOptions(true, ScreenOrientation.LANDSCAPE_SENSOR, new FillResolutionPolicy(), pCamera);
		// Enable sounds.
	...
	public void onCreateResources(OnCreateResourcesCallback pOnCreateResourcesCallback) {
		...
		ResourceManager.getInstance().setup(this.getEngine(), this.getApplicationContext(), DESIGN_SCREEN_WIDTH_PIXELS, DESIGN_SCREEN_HEIGHT_PIXELS, 1,1);
