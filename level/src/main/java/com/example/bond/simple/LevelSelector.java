...
public class LevelSelector extends Entity {
     ...
     * user selection.
     *
     * @param pMaxLevel     Current max unlocked level.
     * @param pChapter      Chapter/world number of this particular LevelSelector.
     * @param pCameraWidth  Camera object's width value.
     * @param pCameraHeight Camera object's height value.
     * @param pScene        The Scene in which the LevelSelector will be displayed on.
     * @param pEngine       AndEngine's mEngine object.
     */
     ...
     * @param pFont          The Font to be displayed by Text written on the tiles,
    ...
    public void createTiles(final ITextureRegion pTextureRegion, final Font pFont) {
        ...
        float tempY = this.mInitialY + (-TILE_DIMENSION - TILE_PADDING) * ROWS;
    ...
    public class LevelTile extends Sprite {
        ...
        public void attachText() {
            ...
            if (this.mTileText == null) {
                ...
                mTileText.setX(mTileText.getX()-mTileText.getWidth()*0.5f);
                mTileText.setY(mTileText.getY()-mTileText.getHeight()*0.5f);
